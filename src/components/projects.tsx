...
const projects = [
  ...
  },
  {
    ...
    subtitle: "Social Media Management Tool",
    description: "Platform manajemen konten untuk influencer dan content creator. Tracking performa konten, scheduling post, analytics engagement rate, dan kolaborasi dengan brand — semua dalam satu dashboard.",
    highlights: ["Content Scheduling", "Analytics", "Engagement Tracking", "Brand Collab"],
    icon: Users,
    demoUrl: null,
